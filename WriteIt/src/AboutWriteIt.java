...
public class AboutWriteIt implements ActionListener {
	...
	l2 = new JLabel(String.format("<html><body style=\"text-align: justify; text-justify:inter-word;\" >%s</body></html>","Credit to Hina Kausar for the name of the Application. Also I would like to thanks Mr. Engimachii Niraj Kr. Gupta for the valuable inputs."));
